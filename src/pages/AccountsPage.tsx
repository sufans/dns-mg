        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={submit} className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2"><Label>平台</Label><Select value={form.platform} onChange={(e) => setForm({ ...form, platform: e.target.value as DNSPlatform })}><option value="dnshe">DNSHE</option><option value="dnsneko">DNSNEKO</option><option value="gleam">GLEAM</option></Select></div>
              ...
              {form.platform === 'gleam' ? <div className="space-y-2"><Label>GLEAM API Key</Label><Input type="password" value={form.apiKey} onChange={(e) => setForm({ ...form, apiKey: e.target.value })} required placeholder="hl6_xxxxxxxxxxxx" /></div> : null}
