...
import type { UnifiedDomain } from '@/plugins/dns-platforms/types';
...
function getDomainStatus(domain: UnifiedDomain): 'active' | 'expired' | 'suspended' {
...
function getRowClassName(domain: UnifiedDomain): string {
...
function exportCSV(domains: UnifiedDomain[], accountsMap: Map<string, string>) {
  const BOM = '\uFEFF';
...
export function DomainsPage() {
  ...
  const allDomains: UnifiedDomain[] = (domainsData?.domains as UnifiedDomain[]) || [];
