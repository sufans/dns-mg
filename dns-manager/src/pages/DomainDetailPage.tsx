...
import type { UnifiedDomain, UnifiedRecord } from '@/plugins/dns-platforms/types';
...
export function DomainDetailPage() {
  ...
  const unifiedDomain = domain as UnifiedDomain | undefined;
  const unifiedRecords = (records as unknown as UnifiedRecord[]) || [];
